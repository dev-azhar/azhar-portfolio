...
const projects = [
  {
    ...
    stack: ["FastAPI", "Nuxt 3 / Vue", "PostgreSQL", "WebSockets", "Microservices", "Azure AKS"],
  ...
  },
  {
    ...
    stack: ["Vue", "SPA", "Component-driven"],
  ...
  },
  {
    ...
    stack: ["TypeScript", "React", "Three.js", "GSAP", "Vercel"],
